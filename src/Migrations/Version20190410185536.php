 ...
 */
final class Version20190410185536 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE categories_restaurant (categories_id INT NOT NULL, restaurant_id INT NOT NULL, INDEX IDX_4A1B5237A21214B7 (categories_id), INDEX IDX_4A1B5237B1E7706E (restaurant_id), PRIMARY KEY(categories_id, restaurant_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
